...
// Объявляем интерфейсы для двух главных задач - обмена данными с сервером и отрисовки UI
...
// Ещё один новый класс, чтобы собрать всё это вместе:
